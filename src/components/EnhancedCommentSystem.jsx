...
const EnhancedCommentSystem = ({
  ...
  const mockComments = {
    1: [
      ...
      },
      {
        ...
        user: "TokyoFoodie",
        content:
          "These hidden gems are what make Tokyo special. As someone learning Japanese, I appreciate the mixed language approach!",
        likes: 31,
        avatar: "TF",
      },
      {
        ...
        user: "LocalGuide",
        content:
          "I've been living in Tokyo for 10 years and still discovering new places like this. The authenticity is incredible!",
        likes: 15,
        avatar: "LG",
      },
      {
        ...
        user: "Sakura_Chan",
        content:
          "家族経営のお店は本当に温かい雰囲気がありますね。おじいさんの笑顔が忘れられません。",
        likes: 22,
        avatar: "SC",
      },
      {
        ...
        user: "FoodExplorer",
        content:
          "The ramen here is absolutely phenomenal! You can taste the generations of tradition in every bowl.",
        likes: 19,
        avatar: "FE",
      },
    ],
    2: [
      {
        ...
        user: "SakuraWatcher",
        content:
          "Italy has beautiful springs too, but sakura season in Japan is legendary! The limited time makes it even more special and valuable.",
        likes: 45,
        avatar: "SW",
      },
      {
        ...
        content:
          "桜の季節は本当に美しいです。毎年完璧な写真を撮ろうとしますが、自然の美しさは写真を超えています。",
        likes: 28,
        avatar: "NP",
      },
      {
        ...
        user: "SpringLover",
        content:
          "The timing is everything with sakura! You have to plan your trip perfectly to catch the peak bloom.",
        likes: 15,
        avatar: "SL",
      },
      {
        ...
        user: "Hanami_Expert",
        content:
          "花見の文化は日本の心です。家族や友達と一緒に桜の下で過ごす時間は本当に特別ですね。",
        likes: 33,
        avatar: "HE",
      },
      {
        ...
        user: "TravelBlogger",
        content:
          "I've traveled to Japan three times just for sakura season. Each experience is unique and magical!",
        likes: 27,
        avatar: "TB",
      },
      {
        ...
        user: "TokyoResident",
        content:
          "毎年桜を見ていても、その美しさに感動します。短い期間だからこそ、より一層貴重に感じられます。",
        likes: 41,
        avatar: "TR",
      },
    ],
    3: [
      {
        ...
        user: "FashionForward",
        content:
          "Tokyo's fashion scene is incredible! The way young designers blend traditional and modern elements is inspiring.",
        likes: 22,
        avatar: "FF",
      },
      {
        ...
        user: "StreetStyleFan",
        content:
          "原宿のストリートファッションは世界中で有名です。創造性と自己表現の最高峰です！",
        likes: 19,
        avatar: "SS",
      },
      {
        ...
        user: "TokyoExplorer",
        content:
          "I love how Tokyo combines old and new so seamlessly. Every street corner has a story!",
        likes: 15,
        avatar: "TE",
      },
      {
        ...
        user: "FashionStudent",
        content:
          "日本のファッションデザインから多くのインスピレーションを得ています。伝統と革新の完璧なバランスです。",
        likes: 28,
        avatar: "FS",
      },
      {
        ...
        content:
          "Harajuku is like a living fashion museum! Every visit I discover new trends and creative expressions.",
        likes: 34,
        avatar: "SI",
      },
      {
        ...
        user: "DesignLover",
        content:
          "若いデザイナーたちの創造力は本当に素晴らしいです。世界に影響を与える日本のファッション文化を誇りに思います。",
        likes: 26,
        avatar: "DL",
      },
    ],
    4: [
      ...
      },
      {
        ...
        user: "TravelBlogger",
        content:
          "This post perfectly captures the essence of Japanese culture! The blend of tradition and modernity is fascinating.",
        likes: 33,
        avatar: "TB",
      },
      {
        ...
        user: "KyotoNative",
        content:
          "伝統的な建築と現代的なデザインが調和している様子は、日本の美意識を表していますね。",
        likes: 25,
        avatar: "KN",
      },
      {
        ...
        content:
          "The way Japanese architects preserve historical elements while embracing innovation is truly remarkable!",
        likes: 31,
        avatar: "AF",
      },
      {
        ...
        content:
          "日本に住んで5年になりますが、まだまだ学ぶことがたくさんあります。文化の奥深さに感動しています。",
        likes: 22,
        avatar: "CS",
      },
      {
        ...
        user: "HeritageExpert",
        content:
          "Japan's ability to maintain its cultural identity while adapting to global changes is a lesson for the world.",
        likes: 38,
        avatar: "HE",
      },
    ],
    5: [
      {
        ...
        content:
          "Traditional takoyaki and okonomiyaki are amazing, but the fusion cuisine here is incredible! Korean-Japanese and Italian-Japanese combinations are especially popular.",
        likes: 41,
        avatar: "FA",
      },
      {
        ...
        user: "OsakaLocal",
        content:
          "大阪の食べ物は世界一です！この記事は私たちの食文化を完璧に表現しています。",
        likes: 27,
        avatar: "OL",
      },
      {
        ...
        user: "ChefInTraining",
        content:
          "The creativity in Osaka's food scene is unmatched! Every dish tells a story of cultural fusion and innovation.",
        likes: 35,
        avatar: "CT",
      },
      {
        ...
        user: "FoodCritic",
        content:
          "関西の味付けは本当に独特で美味しいです。特に出汁の文化は他の地域では味わえない深みがあります。",
        likes: 29,
        avatar: "FC",
      },
      {
        ...
        content:
          "Dotonbori is a food paradise! The energy, the flavors, the atmosphere - it's an unforgettable culinary experience.",
        likes: 33,
        avatar: "SF",
      },
      {
        ...
        content:
          "大阪で食べた料理は忘れられません。伝統的な味と新しいアイデアの組み合わせが素晴らしいです。",
        likes: 24,
        avatar: "CE",
      },
    ],
    6: [
      {
        ...
        user: "ArchitectureFan",
        content:
          "The blend of traditional and modern architecture in Japan is breathtaking. Every building tells a story!",
        likes: 19,
        avatar: "AF",
      },
      {
        ...
        user: "DesignStudent",
        content:
          "日本の建築デザインから多くのインスピレーションを得ています。伝統と革新の完璧なバランスです。",
        likes: 24,
        avatar: "DS",
      },
      {
        ...
        user: "UrbanPlanner",
        content:
          "Tokyo's skyline is a masterpiece of architectural evolution. Ancient temples coexist beautifully with modern skyscrapers.",
        likes: 32,
        avatar: "UP",
      },
      {
        ...
        content:
          "木造建築の技術は本当に素晴らしいです。何百年も前の建物が今でも美しく保たれているのは驚きです。",
        likes: 28,
        avatar: "BE",
      },
      {
        ...
        content:
          "Every visit to Japan reveals new architectural wonders. The attention to detail and craftsmanship is unparalleled!",
        likes: 26,
        avatar: "AT",
      },
      {
        ...
        content:
          "日本の建築技術は世界最高レベルです。地震に強い構造と美しいデザインを両立させる技術力に感動します。",
        likes: 35,
        avatar: "CE",
      },
    ],
  ...
  const handleWordClick = async (word, isJapanese, context = null) => {
    ...
    const fullContextTranslation = null
          ...
          <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <div className="space-y-2">
              <div className="p-3 bg-white rounded border border-blue-200">
                ...
                <button
                  onClick={() =>
                    setCommentText("This looks amazing! どこですか？")
                  }
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  >
                    <Heart
                      className={`w-4 h-4 ${likedComments.has(comment.id) ? "fill-red-500" : ""}`}
                    />
